...
unsigned int> Digits(T value) {
  return  (value < Bits<T>::template Power<10, 5>()) ?
      (value < Bits<T>::template Power<10, 2>()) ?
        (value < Bits<T>::template Power<10, 1>()) ? 1 : 2
      :
      (value < Bits<T>::template Power<10, 4>()) ?
        (value < Bits<T>::template Power<10, 3>()) ? 3 : 4
      : 5
    :
    (value < Bits<T>::template Power<10, 7>()) ?
      (value < Bits<T>::template Power<10, 6>()) ? 6 : 7
    :
    (value < Bits<T>::template Power<10, 9>()) ?
      (value < Bits<T>::template Power<10, 8>()) ? 8 : 9
    : 10;
}
...
unsigned int> Digits(T value) {
  return  (value < Bits<T>::template Power<10, 10>()) ?
      Digits<number_base, 32>(value)
    :
    (value < Bits<T>::template Power<10, 15>()) ?
      (value < Bits<T>::template Power<10, 12>()) ?
        (value < Bits<T>::template Power<10, 11>()) ? 11 : 12
      :
      (value < Bits<T>::template Power<10, 14>()) ?
        (value < Bits<T>::template Power<10, 13>()) ? 13 : 14
      : 15
    :
    (value < Bits<T>::template Power<10, 17>()) ?
      (value < Bits<T>::template Power<10, 16>()) ? 16 : 17
    :
    (value < Bits<T>::template Power<10, 19>()) ?
      (value < Bits<T>::template Power<10, 18>()) ? 18 : 19
    : 20;
}
...
unsigned int> Digits(T value) {
  constexpr const T next_pow10 = Bits<T>::template Power<10, 20>();
  if (value < next_pow10) {
...
inline constexpr EnableIf<All<
    Bool<number_base == 10>, Bool<Bits<T>::template InRange<0, 32>()>>,
unsigned int> Digits(T value) {
...
template <unsigned int number_base, class T>
inline constexpr EnableIf<All<
    Bool<number_base == 10>, Bool<Bits<T>::template InRange<33, 64>()>>,
unsigned int> Digits(T value) {
...
template <unsigned int number_base, class T>
inline EnableIf<All<
    Bool<number_base == 10>, Bool<Bits<T>::template InRange<65>()>>,
unsigned int> Digits(T value) {
...
constexpr EnableIf<
    Bool<Bits<T>::template InRange<0, 64>()>,
unsigned int> Digits(T value) {
...
template <unsigned int number_base = 10, class T>
EnableIf<
    Bool<Bits<T>::template InRange<65>()>,
unsigned int> Digits(T value) {
  return detail::Digits<number_base>(value);
}
